...
import "contracts/Libraries/Modifiers/modifiers.sol";
...
contract EntityManagement is SignatureVerifier {
    ...
    function setEntity() public OnlyAgent isSetEntity alreadySet returns(bool){
    ...
    function getEntity() public completedSet OnlyAgent isGetEntity returns (string memory){
    ...
    function setDidDoc1() public OnlyAgent completedSet alreadyDoc isSetDidDoc returns (bool){
        counter1++;
    ...
    function getDidDoc() public completedSet completedDoc OnlyAgent isGetDidDoc returns (string memory){
         _publicKey = users[agent].publicKey;
        users[agent].method = method_Str;
        users[agent].signature = signature;
        users[agent].typeOfKey = typeOfKey;
